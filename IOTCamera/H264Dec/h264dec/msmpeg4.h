...
extern VLC222 ff_mb_non_intra_vlc[4];
extern VLC222 ff_inter_intra_vlc;

void ff_msmpeg4_code012(PutBitContext *pb, int n);
void ff_msmpeg4_encode_block(MpegEncContext222 * s, DCTELEM222 * block, int n);
void ff_msmpeg4_handle_slices(MpegEncContext222 *s);
void ff_msmpeg4_encode_motion(MpegEncContext222 * s, int mx, int my);
int ff_msmpeg4_coded_block_pred(MpegEncContext222 * s, int n,
                                uint8_t **coded_block_ptr);
int ff_msmpeg4_decode_motion(MpegEncContext222 * s, int *mx_ptr, int *my_ptr);
int ff_msmpeg4_decode_block(MpegEncContext222 * s, DCTELEM222 * block,
                            int n, int coded, const uint8_t *scan_table);
int ff_wmv2_decode_mb(MpegEncContext222 *s, DCTELEM222 block[6][64]);
