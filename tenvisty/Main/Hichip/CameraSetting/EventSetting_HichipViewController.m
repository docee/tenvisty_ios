...
-(NSArray *)listItems{
    if(!_listItems){
        ...
        NSArray *sec2 = [[NSArray alloc] initWithObjects:[ListImgTableViewCellModel initObj:@"ic_push2" title:LOCALSTR(@"Alarm Push") showValue:YES value:self.camera.remoteNotifications>0?@"1":@"0" viewId:TableViewCell_Switch],nil];
        NSArray *sec3 = [[NSArray alloc] initWithObjects:[ListImgTableViewCellModel initObj:@"ic_record_alarm" title:LOCALSTR(@"Alarm Recording") showValue:YES value:nil viewId:TableViewCell_Switch],nil];
