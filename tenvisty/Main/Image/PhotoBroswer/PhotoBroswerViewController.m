...
//    self.view.backgroundColor = Color_OuterView_BG;
//    
...
//        [btnBack setImage:[UIImage imageNamed:@"camhi_home_back_black"] forState:UIControlStateNormal];
...
//    // Was there an error?
//    if (error != NULL) {
//        [weakSelf presentAlertTitle:nil message:[NSString stringWithFormat:INTERSTR(@"Please enable \"%@\" in Mobile \"Set-Privacy-Photos\""),[[NSBundle mainBundle] objectForInfoDictionaryKey:@"CFBundleDisplayName"]] alertStyle:UIAlertControllerStyleAlert actionDefaultTitle:INTERSTR(@"OK") actionDefaultBlock:^{
//            [weakSelf goPhoneSettingPage:@"prefs:root=NOTIFICATIONS_ID"];
//            
//        } actionCancelTitle:INTERSTR(@"Cancel") actionCancelBlock:^{
//            
//        }];
//        //[HXProgress showText:error.domain];
//    }
...
//        [btnMore setImage:[UIImage imageNamed:@"camhi_home_more_blue"] forState:UIControlStateNormal];
