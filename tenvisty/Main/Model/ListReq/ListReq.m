...
- (STimeDay)getTimeDay:(long)time {
    ...
    result.year = [dateComponents year];// [[self.tFormatter stringFromDate:date] intValue];
    
    //[self.tFormatter setDateFormat:@"MM"];
    result.month = [dateComponents month];// [[self.tFormatter stringFromDate:date] intValue];
    
    //[self.tFormatter setDateFormat:@"dd"];
    result.day = [dateComponents day]; //[[self.tFormatter stringFromDate:date] intValue];
    
    //[self.tFormatter setDateFormat:@"e"];
    result.wday = [dateComponents weekday]; //[[self.tFormatter stringFromDate:date] intValue];
    
    //[self.tFormatter setDateFormat:@"HH"];
    result.hour = [dateComponents hour]; //[[self.tFormatter stringFromDate:date] intValue];
    
    //[self.tFormatter setDateFormat:@"mm"];
    result.minute = [dateComponents minute];// [[self.tFormatter stringFromDate:date] intValue];
    
    //[self.tFormatter setDateFormat:@"ss"];
    result.second = [dateComponents second];// [[self.tFormatter stringFromDate:date] intValue];
