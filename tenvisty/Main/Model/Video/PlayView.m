...
- (UIButton *)btnPlay {
    if (!_btnPlay) {
        ...
        _btnPlay.tag = 0;
        [_btnPlay setImage:[UIImage imageNamed:@"camhi_video_pause"] forState:UIControlStateNormal];
        [_btnPlay setImage:[UIImage imageNamed:@"camhi_video_play"] forState:UIControlStateSelected];
...
- (UIButton *)btnExit {
    if (!_btnExit) {
        ...
        _btnExit.tag = 1;
        [_btnExit setImage:[UIImage imageNamed:@"camhi_live_normal_exit"] forState:UIControlStateNormal];
