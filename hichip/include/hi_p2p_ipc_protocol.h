...
#define HI_P2P_STREAM_H264        4
#define HI_P2P_STREAM_H265        5
...
/*****************HI_P2P_LOGIN***********************/
#define P2P_ENCODE_LEN_EXT 688

/*****************HI_P2P_LOGIN 增加265位密码***********************/
...
typedef struct
{
    HI_U32   u32LoginLevel;/*0: 管理员,1:user 2:guest*/
    HI_CHAR sLognInfo[P2P_ENCODE_LEN];
    HI_CHAR sLognInfo_EXT[P2P_ENCODE_LEN_EXT];
}HI_P2P_LOGIN_INFO_EXT;
/*****************HI_P2P_LOGIN***********************/
...
#define HI_P2P_AUTH_LEN_EXT 342
/*****************HI_P2P_GET_USER_PARAM_EXT***********************/
typedef struct
{
    HI_U8 u8UserName[HI_P2P_AUTH_LEN_EXT];
    
    HI_U8 u8Password[HI_P2P_AUTH_LEN_EXT];
    HI_U32   u32UserLevel;/*0: 管理员,1:user 2:guest*/
} HI_P2P_S_AUTH_EXT;
/*****************HI_P2P_GET_USER_PARAM_EXT***********************/

/*****************HI_P2P_SET_USER_PARAM_EXT***********************/
typedef struct
{
...
typedef struct
{
    HI_U8 sReserved[4];            /*sReserved[0]标记HI_P2P_STREAM_H264/HI_P2P_STREAM_H265*/
...
/*************** HI_P2P_GET_WIFI_PARAM_NEWPWD255_EXT**************/
typedef struct
{
    HI_U32 u32Channel;/*ipc: 0*/
    HI_U32 u32Enable;
    ...
    HI_CHAR strSSID[32];
    HI_CHAR strKey[64];
} HI_P2P_S_WIFI_PARAM_NEWPWD255_EXT;


/*************** HI_P2P_GET_WIFI_PARAM_NEWPWD255_EXT**************/

/*************** HI_P2P_SET_WIFI_PARAM_NEWPWD255_EXT**************/
typedef struct
{
    HI_U32 u32Channel;/*ipc: 0*/
    HI_U32 u32Enable;
    ...
    HI_CHAR strKey[64];
    HI_U32 u32Check;                        /*1: check, 0:nocheck*/
} HI_P2P_S_WIFI_CHECK_NEWPWD255_EXT;
...
/*********HI_P2P_GET_FTP_PARAM_EXT_NEWPWD255_EXT HI_P2P_SET_FTP_PARAM_EXT_NEWPWD255_EXT**********/
...
typedef struct
{
    ...
    HI_U32  u32Port;
    HI_U32  u32Mode;
    HI_CHAR strUsernm[128];
    HI_CHAR strPasswd[256];
    HI_CHAR strFilePath[256];
    HI_U32 u32CreatePath;            /*自动创建目录, 1:创建, 0:不创建*/
    HI_U32 u32Check;                /*1:check, 0:no check*/
    HI_CHAR strReserved[8];        /*预留*/
...
} HI_P2P_S_FTP_PARAM_EXT_NEWPWD255_EXT;
...
/*******HI_P2P_GET_EMAIL_PARAM_NEWPWD255_EXT*******/
...
typedef struct
{
    ...
    HI_CHAR strSubject[128];
    HI_CHAR strText[128];
} HI_P2P_S_EMAIL_PARAM_NEWPWD255_EXT;

/*******HI_P2P_GET_EMAIL_PARAM_NEWPWD255_EXT*******/


/*******HI_P2P_SET_EMAIL_PARAM_NEWPWD255_EXT*******/
...
typedef struct
{
    ...
    HI_U32  u32Check;                /*1:check,  0:no check*/
    HI_CHAR strReserved[8];        /*预留*/
} HI_P2P_S_EMAIL_PARAM_EXT_NEWPWD255_EXT;
...
/*************************HI_P2P_PB_PLAY_CONTROL_EXT************************/
/*仅用HI_P2P_S_PB_FILE_INFO_EXT替换HI_P2P_PB_PLAY_CONTROL接口的HI_P2P_S_PB_FILE_INFO结构体*/
typedef struct
{
    HI_U32 u32VideoWidth;
    HI_U32 u32VideoHeight;
    HI_U32 u32AudioType;
    HI_U32 u32Command;
    HI_U32 u32EncodeType;            /*编码类型HI_P2P_STREAM_H264/HI_P2P_STREAM_H265*/
    HI_S8 sReserved[4];
} HI_P2P_S_PB_FILE_INFO_EXT;
/*************************HI_P2P_PB_PLAY_CONTROL_EXT************************/
...
typedef struct
{
    ...
    HI_CHAR sType[16];        /*IPCRF 类型 HI_P2P_IPCRF_SENSOR_TYPE_TEMP */
    HI_CHAR sReserved[16];
} HI_P2P_EVENT;
/***************************HI_P2P_ALARM_EVENT****************************/
...
typedef struct
{
    ...
    HI_U32 u32Wdrsth;        /*宽动态强度[1-30]设置和获取*/
    HI_U32 sReserve[3];
} HI_P2P_SP_IMAGE;
/**************************HI_P2P_GET_SP_IMAGE_PARAM_EXT**************************/
/**************************HI_P2P_GET_SP_IMAGE_PARAM*************************/
...
typedef struct
{
    ...
    HI_CHAR  sReserved[4];        /*sReserved[0]: 编码类型HI_P2P_STREAM_H264/HI_P2P_STREAM_H265*/
...
typedef struct
{
    ...
    HI_CHAR  sReserved[3];        /*sReserved[0]: 编码类型HI_P2P_STREAM_H264/HI_P2P_STREAM_H265*/
...
typedef struct
{
    ...
    HI_S8 s8AlarmVoiceLink;    /*警号联动*/
    HI_S8 s8PtzLink;        /*云台联动*/
    HI_S8 sReserved[6];
} HI_P2P_IPCRF_INFO;
/********************HI_P2P_IPCRF_SINGLE_INFO_GET******************/
...
{
    HI_U32 u32Flag;        /*0: 开始标志,1:结束标志*/
    HI_P2P_IPCRF_INFO sRfInfo[HI_P2P_IPCRF_MAXNUM/2];    //分两次发送，每次8个RF信息
...
/**********************HI_P2P_ALARM_MAIN_GET***********************/
typedef struct
{
    HI_U32 u32Enable;    /*0 关闭,    1 开启*/
    HI_CHAR sReserved[4];
}HI_P2P_ALARM_MAIN;
/**********************HI_P2P_ALARM_MAIN_GET***********************/
...
/***HI_P2P_TRANSPARENT_CHN_0_GET**HI_P2P_TRANSPARENT_CHN_0_SET***/
typedef struct
{
    HI_U32 u32Flag;                /*'s': 开始, 'e': 结束*/
    HI_U16 u16OnceLen;            /*本次发送数据长度*/
    HI_U16 u16TotalLen;            /*数据总长度长度(>1)*/
    HI_CHAR sData[0];             /*每条命令发送大小最大992个字节*/
}HI_P2P_TRANSPARENT_CHN_INFO;
/***HI_P2P_TRANSPARENT_CHN_0_GET**HI_P2P_TRANSPARENT_CHN_0_SET***/

/***HI_P2P_GET_SMART_MOTO  HI_P2P_SET_SMART_MOTO***/
typedef struct
{
    HI_BOOL bSmartTrack;
    HI_CHAR sReserve[4];
...
/***HI_P2P_GET__TIMER_REBOOT  HI_P2P_SET__TIMER_REBOOTO***/
typedef struct
{
    HI_BOOL bEnable;
    HI_U32  u32Day;//[0~6周日~周六,7全星期]
    HI_U32  u32Hour;//[0~23]
    HI_CHAR sReserve[4];
}HI_P2P_TIMER_REBOOT;
/***HI_P2P_GET__TIMER_REBOOT  HI_P2P_SET__TIMER_REBOOT***/

/************HI_P2P_PB_PLAY_CONTROL_ALARM**************/
/*录像回放文件信息用HI_P2P_S_PB_PLAY_REQ*/


#define HI_P2P_ALARM_VIDEO_AVI    0
#define HI_P2P_ALARM_VIDEO_264    1
typedef struct
{
    HI_U32 u32VideoWidth;
    HI_U32 u32VideoHeight;
    HI_U32 u32size;      /*文件大小,单位: 字节*/
    HI_U32 u32FileType;  /* HI_P2P_ALARM_VIDEO_AVI / HI_P2P_ALARM _VIDEO_264*/
    HI_U32 u32AudioType;
    HI_U32 u32Command;
    HI_U32 u32EncodeType;    /*编码类型HI_P2P_STREAM_H264/HI_P2P_STREAM_H265*/
    HI_S8 sReserved[4];
} HI_P2P_S_PB_FILE_INFO_ALARM_RESP;

/************HI_P2P_PB_PLAY_CONTROL_ALARM**************/

/************ HI_P2P_GET_ALARM_LOG_EXT**************/
typedef struct
{
    HI_CHAR szSrcLog[136];
} HI_P2P_ALARMLOG_EXT;
typedef struct
{
    HI_U32 u32CmdType;        /*命令类型，如对讲时填入HI_P2P_GET_ALARM_LOG_EXT */
    HI_S8 sReserved[4];
    HI_U32 u32Length;                        //数据长度
} HI_P2P_ALARM_LOG_INFO_EXT;

/************ HI_P2P_GET_ALARM_LOG_EXT**************/


/************HI_P2P_GET_ALARM_LOG_NAME*************/
//接收请用结构体HI_P2P_FILE_INFO
typedef struct
{
    HI_CHAR AlarmTime[16];
    HI_CHAR sReserved[16];
    
}HI_P2P_ALARM_TIME;//发送时间
...
/************HI_P2P_SET_ALARM_SWITCH HI_P2P_GET_ALARM_SWITCH****************/
typedef struct
{
    HI_S32 enable;//0:关1:开
    HI_S32 sReserved[4];
    
}HI_P2P_ALARM_SWITCH;//发送时间
...
#define HI_P2P_ALARM_TOKEN_REGIST        0x00004132        /*报警推送注册，请在首次连接设置时间后调用*/
...
/*录像搜索新增接口，有以下2接口中任何一个，回放、拖动、下载等一律不再考虑夏令时(客户端不需要再减1小时)*/
/*且 修改时区不再需要重启*/
#define HI_P2P_PB_QUERY_START_NODST        0x00004159        /*对应HI_P2P_PB_QUERY_START_NEW*/
#define HI_P2P_PB_QUERY_START_FILE_NODST 0x0000415a        /*对应HI_P2P_PB_QUERY_START_FILE*/

/************新增2016.12.08  报警总开关**********/
#define HI_P2P_ALARM_MAIN_GET             0x0000415b        /*获取报警总开关*/
#define HI_P2P_ALARM_MAIN_SET             0x0000415c        /*设置报警总开关*/

/************新增2016.12.09  录像回放控制新接口**********/
#define HI_P2P_PB_PLAY_CONTROL_EXT        0x0000415d

/************新增2017.01.11报警服务器地址设置/获取接口**********/
#define HI_P2P_ALARM_ADDRESS_GET         0x0000415e        /*获取报警服务器地址*/
#define HI_P2P_ALARM_ADDRESS_SET         0x0000415f        /*设置报警服务器地址*/

/************新增2017.04.12透传通道【0】接口**********/
#define HI_P2P_TRANSPARENT_CHN_0_GET    0x00004160    /*透明通道获取命令(客户端只能被动接收此命令，不能发送指令到设备)*/
#define HI_P2P_TRANSPARENT_CHN_0_SET    0x00004161    /*获取报警服务器地址*/

/************新增2017.04.12宽动态强度接口**********/
#define HI_P2P_GET_SP_IMAGE_PARAM_EXT        0x00004162        /*获取宽动态强度*/
#define HI_P2P_SET_SP_IMAGE_PARAM_EXT        0x00004163        /*设置宽动态强度*/

/************新增2017.06.06时区接口，不在与表对比**********/
#define HI_P2P_GET_TIME_ZONE_EXT    0x00004164    /*获取时区扩展接口*/
#define HI_P2P_SET_TIME_ZONE_EXT 0x00004165    /*设置时区扩展接口*/

/************新增2017.07.13用户名密码支持256位************/
#define HI_P2P_SET_USER_PARAM_EXT 0x00004166 /*设置用户名密码扩展接口(用户名密码256)*/
#define HI_P2P_GET_USER_PARAM_EXT 0x00004167 /*获取用户名密码扩展接口(用户名密码256)*/
#define HI_P2P_GET_EMAIL_PARAM_NEWPWD255_EXT 0x00004168/*获取EMAIL参数扩展接口(用户名密码256)*/
#define HI_P2P_SET_EMAIL_PARAM_NEWPWD255_EXT 0x00004169 /*设置EMAIL参数扩展接口(用户名密码256)*/
#define HI_P2P_GET_FTP_PARAM_EXT_NEWPWD255_EXT 0x0000416a/*获取FTP参数扩展接口(用户名密码256)*/
#define HI_P2P_SET_FTP_PARAM_EXT_NEWPWD255_EXT 0x00000416b/*设置FTP参数扩展接口(用户名密码256)*/
#define HI_P2P_GET_WIFI_PARAM_NEWPWD255_EXT 0x00000416c/*获取wifi参数扩展接口(用户名密码256)*/
#define HI_P2P_SET_WIFI_PARAM_NEWPWD255_EXT 0x00000416e/*设置wifi参数扩展接口(用户名密码256)*/

/************新增2017.08.01智能追踪************/
#define HI_P2P_SET_SMART_MOTO 0x00000416f /*设置智能追踪参数*/
#define HI_P2P_GET_SMART_MOTO 0x000004170 /*获取智能追踪参数*/

//#define HI_P2P_PB_PLAY_FAST 0x000004171 /*设置快速播放*/
/************新增2017.08.24定时重启功能akl*******/
#define HI_P2P_SET_TIMER_REBOOT 0x000004171 /*设置定时重启参数*/
#define HI_P2P_GET_TIMER_REBOOT 0x000004172 /*获取定时重启参数*/

/************新增2017.09.04录像回放*******/
#define HI_P2P_PB_PLAY_CONTROL_ALARM 0x00004173

/************新增2017.09.04报警日志获取扩展接口*******/
#define HI_P2P_GET_ALARM_LOG_EXT 0x00004174

/************新增2017.09.13报警日志获取录像接口*******/
#define HI_P2P_GET_ALARM_LOG_NAME 0x00004175

/************新增2017.09.20获取设置开关状态接口*******/


//20171020新增：
#define HI_P2P_GET_RING 0x00004177
#define HI_P2P_RING     0x000004176
/************HI_P2P_RING****************/
typedef struct
{
    HI_BOOL enable;
...
/************–¬‘ˆΩ”ø⁄2017.11.1ªÒ»°…Ë±∏¿‡–Õ********/
#define HI_P2P_GET_DEVICE_MOLD_PARAM 0x00004178
typedef struct
{
    HI_U8 mold;//0:非鱼眼 1鱼眼
